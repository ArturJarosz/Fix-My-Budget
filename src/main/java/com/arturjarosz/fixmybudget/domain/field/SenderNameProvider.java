...
@Component
public class SenderNameProvider implements FieldProvider {
    @Override
    public void enrichTransaction(BankTransaction transaction, String value) {
        transaction.setSenderName(value);
    }

    @Override
    public FieldType getFieldType() {
        return FieldType.SENDER_NAME;
    }
    ...
    public FieldToEvaluate getFieldToEvaluate(BankTransaction transaction) {
        return FieldToEvaluate.builder()
                ...
                .textValue(transaction.getSenderName())
                .build();
    }
}
